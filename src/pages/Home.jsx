...
const Home = () => {
    ...
    return (
        <div className='    pt-5'>
            ...
            <div className=" w-[85%] mx-auto single-book flex flex-col sm:flex-row gap-2 h-full">
                <div className="left-image-gallery w-[100%] min-h-[100%] sm:w-[65%] md:w[55%]">
                    <ImageGallery  thumbnailPosition='left' lazyLoad items={images} />
                </div>
                <div className='book-details flex-1 flex items-center  flex-col'>
                    <h3 className='text-2xl poppins-medium'>Where are You?</h3>
                    ...
                    <div className="book-description">
                        <p className='p-2'>A personalized search-and-find extravaganza, where you’re looking for… yourself! The first in the Where Are You collection, children will love exploring 6 alternative universes, spotting different versions of themselves – along with oodles of other fun challenges.</p>
                    </div>
                    <div className="book-subinfo flex flex-col  self-start mt-3">
                        <p className='flex  gap-3 px-2'><CiGift size={25} />Recommended for ages 4 to 10</p>
                        <p className='flex  gap-3 px-2'><IoMdBook size={25} />Preview all 36 pages before buying</p>
                        <p className='flex  gap-3 px-2'><CiGlobe size={25} />Printed and dispatched in 2-4 working days</p>
                        <p className='flex  gap-3 px-2'><FaRegHeart size={25} />Upload a special photo for free</p>
                    </div>
                    ...
                    <div className="button-pry mt-3 w-full poppins-regular ">
                        <button className='w-full rounded-md p-3 bg-black hover:bg-white box-border hover:text-black hover:border transition-all text-white'>Personlize my Book</button>
                    </div>
                    ...
                    <div className="faqs">
                        <div className="faqs w-[100%] text-lg mx-auto my-5">
            ...
            <div className="why-choose-us mt-5 w-[85%] mx-auto flex flex-col gap-10">
                <div className="750 flex items-center justify-around gap-20 flex-col md:flex-row">
                    ...
                    <div className="desc poppins-regular flex flex-col gap-10">
                        ...
                        <p className='w-[80%] text-gray-600 poppins-light'>From braids to curls, and dark skin to light, bring your little character to life by choosing from a range of natural skin tones and hairstyles. Every character is hand-drawn by bestselling illustrator Marija Tiurina.</p>
                    </div>
                </div>
                <div className="deli flex items-center flex-col-reverse justify-around gap-20  md:flex-row-reverse">
                    ...
                    <div className="desc poppins-regular flex flex-col gap-10">
                        ...
                        <p className='w-[80%] text-gray-600 poppins-light'>With so much to see, kids will get lost in the illustrations for hours. Try it yourself, above – can you find the walking egg, pigeon doctor and laid-back walrus?</p>
                    </div>
                </div>
                <div className="deli flex items-center  justify-around gap-20 flex-col sm:flex-row">
                    ...
                    <div className="desc poppins-regular flex flex-col gap-10">
                        ...
                        <p className='w-[80%] text-gray-600 poppins-light'>Screens don’t stand a chance with awesome search-and-find books around. Save 30% when you buy 2 or more books in the series in the series with code EPICBUNDLE, and send them on even more epic adventures.</p>
                    </div>
                </div>
            </div>
            {/* reviews  */}
